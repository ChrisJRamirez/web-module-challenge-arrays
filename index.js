...
function copy (){
    const originalFlavorsSpread = [...originalFlavors];
    console.log (originalFlavorsSpread);
    return originalFlavorsSpread
}   
copy ();
...
function addFlavor(arr,newFlavorRainbow){
    arr.unshift(newFlavorRainbow);
    return arr;
}
...
function removeLastFlavor(arrLast,removeLastItem){
   arrLast.pop(removeLastItem);
   return arrLast;
}
